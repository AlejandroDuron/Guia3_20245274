...
export default function App() {
    ...
    const [watched, setWatched] = useState(function () {
        ...
        // Si existe algo guardado lo convertimos a array y si no, devolvemos array vacio
        return storedValue ? JSON.parse(storedValue) : [];
    });

    useEffect(function(){
        // Cada vez que watched cambie, guardamos la nueva lista en localStorage
    ...
    */
    ...
    // Funcion para eliminar una pelicula de la lista watched
